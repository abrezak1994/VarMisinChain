...
eval("//  Variables\nvar categories = document.querySelectorAll(\".left-aside-menu-list-item\");\nvar midContentMainItemList = document.querySelector(\".mid-content-main-item-list\");\nvar midContentMainItems = document.querySelectorAll(\".mid-content-main-item\");\nvar loginBtn = document.getElementById(\"login\");\nvar signupBtn = document.getElementById(\"signup\");\nvar loginActionBtn = document.getElementById(\"login-action-button\");\nvar loginCard = document.getElementById(\"login-card\");\nvar closeLoginTab = document.getElementById(\"close-login-tab\");\nvar ratiosList = document.querySelectorAll(\".ratios-list\");\nvar ratiosListElements = document.querySelectorAll(\".ratio\");\nvar addToCouponText = document.querySelectorAll(\".add-to-coupon-text\");\nvar competitionDetails = document.getElementsByClassName(\"competition-details\");\nvar footballData = document.getElementById(\"football\");\nvar basketballData = document.getElementById(\"basketball\");\nvar volleyballData = document.getElementById(\"volleyball\");\nvar tennisData = document.getElementById(\"tennis\");\nvar handballData = document.getElementById(\"handball\");\nvar americanFootballData = document.getElementById(\"americanfootball\");\n\n// Functions\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  var template = \"\\n        <li>\\n            <div class=\\\"mid-content-main-item\\\">\\n                <div class=\\\"competition-code\\\">T45</div>\\n                <div class=\\\"competition-teams\\\">\\n                    <div class=\\\"competition-team\\\">Manchester United</div>\\n                    <div class=\\\"competition-score\\\">0-1</div>\\n                    <div class=\\\"competition-team\\\">Bayern Munich</div>\\n                </div>\\n                <div class=\\\"competition-date ongoing\\\">45<span class=\\\"ongoing-fade\\\">'</span></div>\\n            </div>\\n            <div class=\\\"competition-details\\\" style=\\\"display: none;\\\">\\n                <div class=\\\"ratios\\\">\\n                    <ul id=\\\"ratios-list\\\">\\n                        <li class=\\\"ratio\\\" value=\\\"2.34\\\"><div class=\\\"ratio-inner\\\">\\u0130Y:1</div><div style=\\\"font-size: 14px;\\\">2.34</div></li>\\n                        <li class=\\\"ratio\\\" value=\\\"1.20\\\"><div class=\\\"ratio-inner\\\">\\u0130Y:0</div><div style=\\\"font-size: 14px;\\\">1.20</div></li>\\n                        <li class=\\\"ratio\\\" value=\\\"3.60\\\"><div class=\\\"ratio-inner\\\">\\u0130Y:2</div><div style=\\\"font-size: 14px;\\\">3.60</div></li>\\n                        <li class=\\\"ratio\\\" value=\\\"1.56\\\"><div class=\\\"ratio-inner\\\">MS:1</div><div style=\\\"font-size: 14px;\\\">1.56</div></li>\\n                        <li class=\\\"ratio\\\" value=\\\"4.32\\\"><div class=\\\"ratio-inner\\\">MS:0</div><div style=\\\"font-size: 14px;\\\">4.32</div></li>\\n                        <li class=\\\"ratio\\\" value=\\\"15.24\\\"><div class=\\\"ratio-inner\\\">MS:2</div><div style=\\\"font-size: 14px;\\\">15.24</div></li>\\n                    </ul>\\n                </div>\\n                <div class=\\\"add-to-coupon\\\">\\n                    <input type=\\\"text\\\" name=\\\"text\\\" disabled id=\\\"add-to-coupon-text\\\" value=\\\"Total Earn Amount: \\\">\\n                    <input type=\\\"button\\\" value=\\\"Add to Coupon\\\">\\n                </div>\\n            </div>\\n        </li>\\n    \";\n  ratiosList.forEach(function (element) {\n    element.classList.add(\"wrap\");\n  });\n\n  // for (let index = 0; index < 20; index++) {\n  //     midContentMainItemList.insertAdjacentHTML(\"beforeend\", template);\n\n  // }\n});\nloginBtn.addEventListener(\"click\", function (e) {\n  e.preventDefault();\n  loginCard.style.display = \"block\";\n});\nloginActionBtn.addEventListener(\"click\", function (e) {\n  e.preventDefault();\n  console.log(\"database access control actions\");\n  //  database access control actions\n});\ncloseLoginTab.addEventListener(\"click\", function (e) {\n  e.preventDefault();\n  loginCard.style.display = \"none\";\n});\nmidContentMainItemList.addEventListener(\"click\", function (e) {\n  var selectedCompetition = e.target.closest(\"li\");\n  var detail = selectedCompetition.querySelector(\".competition-details\");\n  if (detail.style.display == \"none\") {\n    detail.style.display = \"block\";\n  } else {\n    detail.style.display = \"none\";\n  }\n});\nratiosList.forEach(function (element) {\n  element.addEventListener(\"click\", function (e) {\n    var selectedLi = e.target.closest(\"li\");\n    ratiosListElements.forEach(function (element) {\n      if (element.classList.contains(\"selected\")) element.classList.remove(\"selected\");\n    });\n    selectedLi.classList.add(\"selected\");\n    var ratio = selectedLi.getAttribute(\"value\");\n    addToCouponText.value = \"Total Earn Amount: \" + (parseFloat(ratio) * 10).toFixed(2) + \"ETH\";\n  });\n});\nfootballData.addEventListener(\"click\", function () {\n  LoadFootballData();\n});\nbasketballData.addEventListener(\"click\", function () {\n  LoadBasketballData();\n});\nvolleyballData.addEventListener(\"click\", function () {\n  LoadVolleyballData();\n});\ntennisData.addEventListener(\"click\", function () {\n  LoadTennisData();\n});\nhandballData.addEventListener(\"click\", function () {\n  LoadHandballData();\n});\namericanFootballData.addEventListener(\"click\", function () {\n  LoadAmericanFootballData();\n});\nvar LoadFootballData = function LoadFootballData() {\n  var template = \"\\n    <li>\\n        <div class=\\\"mid-content-main-item\\\">\\n            <div class=\\\"competition-code\\\">A83</div>\\n            <div class=\\\"competition-teams\\\">\\n                <div class=\\\"competition-team\\\">Kopenhag</div>\\n                <div class=\\\"competition-score\\\">1-0</div>\\n                <div class=\\\"competition-team\\\">Galatasaray</div>\\n            </div>\\n            <div class=\\\"competition-date ongoing\\\">45<span class=\\\"ongoing-fade\\\">'</span></div>\\n        </div>\\n    </li>\\n    <li>\\n        <div class=\\\"mid-content-main-item\\\">\\n            <div class=\\\"competition-code\\\">T45</div>\\n            <div class=\\\"competition-teams\\\">\\n                <div class=\\\"competition-team\\\">Manchester United</div>\\n                <div class=\\\"competition-score\\\">0-1</div>\\n                <div class=\\\"competition-team\\\">Bayern Munich</div>\\n            </div>\\n            <div class=\\\"competition-date ongoing\\\">45<span class=\\\"ongoing-fade\\\">'</span></div>\\n        </div>\\n    </li>\\n    <li>\\n        <div class=\\\"mid-content-main-item\\\">\\n            <div class=\\\"competition-code\\\">T45</div>\\n            <div class=\\\"competition-teams\\\">\\n                <div class=\\\"competition-team\\\">Manchester United</div>\\n                <div class=\\\"competition-score\\\">0-1</div>\\n                <div class=\\\"competition-team\\\">Bayern Munich</div>\\n            </div>\\n            <div class=\\\"competition-date\\\">23:00</div>\\n        </div>\\n    </li>\\n    <li>\\n        <div class=\\\"mid-content-main-item\\\">\\n            <div class=\\\"competition-code\\\">T45</div>\\n            <div class=\\\"competition-teams\\\">\\n                <div class=\\\"competition-team\\\">Manchester United</div>\\n                <div class=\\\"competition-score\\\">0-1</div>\\n                <div class=\\\"competition-team\\\">Bayern Munich</div>\\n            </div>\\n            <div class=\\\"competition-date\\\">23:00</div>\\n        </div>\\n    </li>\\n    \";\n  midContentMainItemList.innerHTML = \"\";\n  for (var index = 0; index < 5; index++) {\n    midContentMainItemList.insertAdjacentHTML(\"beforeend\", template);\n  }\n};\nvar LoadBasketballData = function LoadBasketballData() {};\nvar LoadVolleyballData = function LoadVolleyballData() {};\nvar LoadTennisData = function LoadTennisData() {};\nvar LoadHandballData = function LoadHandballData() {};\nvar LoadAmericanFootballData = function LoadAmericanFootballData() {};\n\n/*      Competition Template\r\n    <div class=\"mid-content-main-item\">\r\n        <div class=\"competition-code\">A83</div>\r\n        <div class=\"competition-teams\">\r\n            <div class=\"competition-team\">Kopenhag</div>\r\n            <div class=\"competition-score\">1-0</div>\r\n            <div class=\"competition-team\">Galatasaray</div>\r\n        </div>\r\n        <div class=\"competition-date\">23:00</div>\r\n    </div>                           \r\n*/\n\n//# sourceURL=webpack:///./src/js/index.js?");
